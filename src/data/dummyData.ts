...
export const dashboardStats: StatCard[] = [
  ...
  },
  {
    ...
    value: "1,234",
    change: { text: "+3% from last academic year", variant: "positive" },
  ...
  },
  {
    ...
    value: 23,
    change: { text: "High priority", variant: "warning" },
    icon: dashboardIcons.warningTriangle,
    iconColor: "orange",
  },
  {
    id: "active-modules",
...
export const moduleStatsData: Record<
  string,
  { students: number; pendingTasks: number; avgPerformance: number }
> = {
  "advanced-math": {
    students: 42,
    pendingTasks: 8,
...
export const performanceChartData: PerformanceChartData =
  modulePerformanceData["advanced-math"];
...
export const engagementTrendsData: EngagementTrendsData =
  moduleEngagementData["advanced-math"];
